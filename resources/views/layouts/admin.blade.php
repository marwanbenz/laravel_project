    ...
    <nav class="navbar navbar-static-top">
      <ul>
          <li class="pulls-btn">
                ...
                <div class="pull-right">
                  <a href="{{ asset('/users')}}" class="btn btn-default btn-flat">Profile</a>
                </div>
          </li>
      </ul>
    </nav>
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview menu-open">
            ...
            <ul class="treeview-menu" style="">
              <li class="active"><a href="{{ url('/users') }}"><i class="fa fa-circle-o"></i>Users</a></li>
              <li><a href="{{ url('/employer') }}"><i class="fa fa-circle-o"></i>Employers</a></li>
            </ul>
          </li>
